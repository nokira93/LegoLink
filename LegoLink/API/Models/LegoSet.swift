...
public struct LegoSet: Codable, Hashable {
    ...
    public let set_img_url: String?
    public let set_url: String?
    public let last_modified_dt: String
    
    public init(set_num: String, name: String, year: Int?, theme_id: Int?, num_parts: Int, set_img_url: String?, set_url: String?, last_modified_dt: String) {
